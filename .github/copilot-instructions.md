...
<!-- version: 1.1.0 -->
<!-- guid: a7b8c9d0-e1f2-3456-a234-567890123456 -->
...
- All changes to Docker release logic should be made in the embedded Python script within action.yml.
...
This repository provides a composite GitHub Action that builds and releases Docker images.
